...
export default class Slider extends Component {
  ...
  getChild(position) {
    ...
    const ref = c => { this.ref[position] = c }
    return cloneElement(children[index], { ref, firstAppear, current, direction, index, key: index, position, set: this.setSlide, timeout })
  }
  ...
  render() {
    ...
    return (
      <div className={styles.wrapper}>
        <Tracker current={current} length={this.children.length} onClick={this.goTo} />
        <div>
          {this.getChild('prev')}
