...
export default class Grid extends Component {
  ...
  createAnimation() {
    ...
    this.animation = new TimelineMax({ paused: true, delay: 0.5 })
      .staggerFromTo(
        projects,
        0.75,
        { opacity: 0, y: '-100%', pointerEvents: 'none' },
        { opacity: 1, y: '0%', ease: Power2.easeOut, pointerEvents: 'none', clearProps: 'all' },
        0.15,
      )
  }
  ...
  render() {
    ...
    return (
      <div className={styles.wrapper}>
        ...
        <div className={styles.container} ref={c => { this.node = c }}>
          {this.children}
        </div>
        <Indutries />
        <ContactCTA />
