...
export default class LeadershipSlide extends Component {
  ...
  onEntering = (direction, timeout, firstAppear) => {
    this.animation.timeScale(1).delay(timeout * 1.25).restart(true)
  }
        ...
        <div className={styles.container} >
          <div className={styles.content} ref={c => { this.container = c }}>
            ...
            <div style={{ textAlign: 'right' }}>
              <Link className={styles.link} to='/leadership'>- Meet Our Leadership Team</Link>
            </div>
          </div>
          <div className={styles.right} ref={c => { this.image = c }}>
